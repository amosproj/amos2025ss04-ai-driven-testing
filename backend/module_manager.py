...
class ModuleManager:
    ...
    def load_modules(self, module_names: List[str]) -> List[Any]:
        """Load specific modules and return them as a list."""
        loaded = {}
        ...
        for name in module_names:
            ...
            try:
                ...
                if dependencies:
                    ...
                    sub_modules = self.load_modules(dep_names)
                    for sub_module in sub_modules:
                        sub_name = camel_to_snake(sub_module.__class__.__name__)
                        if sub_name not in loaded:
                            loaded[sub_name] = sub_module
