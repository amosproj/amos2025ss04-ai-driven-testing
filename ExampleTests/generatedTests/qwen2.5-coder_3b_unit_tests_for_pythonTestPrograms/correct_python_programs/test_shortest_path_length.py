...
class TestShortestPathLength(unittest.TestCase):
    ...
    def test_shortest_path_length(self):
        ...
        expected_distance = 6
        self.assertEqual(shortest_path_length(self.length_by_edge, self.startnode, self.goalnode), expected_distance)

        # Test case 2: Path through multiple nodes
        expected_distance = 7
        self.assertEqual(shortest_path_length(self.length_by_edge, 'A', 'C'), expected_distance)

        # Test case 3: Goal node is not reachable
        self.assertEqual(shortest_path_length(self.length_by_edge, 'A', 'E'), float('inf'))
