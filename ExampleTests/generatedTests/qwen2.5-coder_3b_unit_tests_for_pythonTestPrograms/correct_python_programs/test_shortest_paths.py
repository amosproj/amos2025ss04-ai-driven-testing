...
class TestShortestPaths(unittest.TestCase):
    ...
    def test_shortest_paths(self):
        ...
        self.assertEqual(shortest_paths(source_node_1, weight_by_edge_1), expected_output_1)
        ...
        self.assertEqual(shortest_paths(source_node_2, weight_by_edge_2), expected_output_2)
        ...
        source_node_3 = 0
        self.assertRaises(ValueError, shortest_paths, source_node_3, weight_by_edge_3)
