...
class Testclass:
    ...
    def test_breadth_first_search(self, bfs_func):
        ...
        self.result.assert_has_value(
            result, "BFS should have returned True when goal was found"
        )
...
def test_breadth_first_search_start_node_none(self, bfs_func):
    ...
    self.result.assert_not_has_value(
        result, "Starting from None node should not return True"
    )
...
def test_breadth_first_search_goal_node_none(self, bfs_func):
    ...
    self.result.assert_not_has_value(
        result, "Ending with None node should not return True"
    )
...
def test_breadth_first_search_success(self, bfs_func):
    ...
    self.result.assert_has_value(
        result, "Should have returned True when goal was found"
    )
